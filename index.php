...
if( !array_key_exists("primary",$_COOKIE)) {setcookie("primary","teal",0,'/'); $_COOKIE["primary"]="teal";}
if( !array_key_exists("secondary",$_COOKIE)) {setcookie("secondary","turquoise",0,'/'); $_COOKIE["secondary"]="turquoise";}
